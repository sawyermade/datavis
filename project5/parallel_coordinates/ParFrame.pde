class ParFrame {
  ...
  ParFrame(Table table, Float xstart, Float ystart, Float w, Float h, String[] iriscol) {
    this.table = table;
    wb = w * bp;
    hb = h * bp;
  ...
  //finds min and max of all columns
  void findMinMax(){
  ...
  void graph(ArrayList<Integer> order){
